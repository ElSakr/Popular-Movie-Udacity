...
/**
 * Created by Amr Sakr on 9/19/2016.
 */
public class MovieProvider extends ContentProvider {
    ...
    static final int TRAILERS_WITH_ID = 103;
    static final int REVIEWS = 104;
    static final int REVIEWS_WITH_ID = 105;
    static final int FAVOURITES = 106;
    static final int FAVOURITES_WITH_ID = 107;
